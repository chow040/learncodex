...
export const autoTradeMockPortfolio = {
    ...
    decisions: [
        {
            ...
            prompt: {
                systemPrompt: 'You are AutoTrader, an LLM decision engine that manages a crypto derivatives portfolio. Respond with JSON decisions for each asset.',
...
export const getMockDecisionById = (decisionId) => autoTradeMockPortfolio.decisions.find((decision) => decision.id === decisionId);
//# sourceMappingURL=autoTradeMock.js.map