...
const extractSystemJson = (sections) => {
...
export const analyzeChartDebate = async (input) => {
    ...
    while (remainingB > 0 || remainingA > 0) {
        ...
        if (remainingA > 0) {
            ...
            debateTurns.push({
                ...
                user: [{ type: 'input_text' }, { type: 'input_image', image_url: dataUrl, detail: 'low' }],
                output: agentAText,
                usage: agentARebuttalResp.usage,
                round: aRoundIndex,
            });
            remainingA -= 1;
        }
    ...
    return {
        ...
        referee: {
            ...
            sections: refereeSections,
            consensusJson,
            ...(refereeResp.usage ? { usage: refereeResp.usage } : {}),
        },
        ...(logFile ? { logFile } : {}),
    };
};
//# sourceMappingURL=chartDebateService.js.map