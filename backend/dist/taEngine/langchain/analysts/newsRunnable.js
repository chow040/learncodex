...
export const buildNewsCollaborationHeader = (context) => {
...
export const buildNewsUserContext = (context) => {
    const sections = [];
...
const buildNewsRunnable = (context) => {
    ...
    if (typeof llm.bindTools === 'function') {
        llmWithTools = llm.bindTools(toolInstances);
    }
    else {
        llmWithTools = llm;
    }
...
//# sourceMappingURL=newsRunnable.js.map