...
const formatToolReminder = (primary) => primary;
export class FundamentalsAnalyst {
    analyze(ctx, symbol, tradeDate) {
        ...
        const addSection = (label, value, primaryTool) => {
