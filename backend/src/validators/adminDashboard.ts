...
export type SystemSettingsPatchInput = z.infer<typeof systemSettingsPatchSchema>;
...
export type CreatePromptProfilePayload = z.infer<typeof createPromptProfileSchema>;
...
export type UpdatePromptProfilePayload = z.infer<typeof updatePromptProfileSchema>;

export const assignPromptSchema = z.object({
  promptProfileId: z.string().uuid(),
});

export type AssignPromptPayload = z.infer<typeof assignPromptSchema>;
...
export type PromptPreviewPayload = z.infer<typeof promptPreviewSchema>;
...
export type PromptProfileQuery = z.infer<typeof promptProfileQuerySchema>;
