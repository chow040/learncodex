...
const formatDateRangeSummary = (query: string, start: Date, end: Date, focus?: string): string => {
  ...
  registerTool({
    ...
    create: (context) =>
      new DynamicStructuredTool({
        ...
        func: async (input) =>
          withToolLogging(TOOL_IDS.STOCK_NEWS_OPENAI, input, context.logger, async () => {
