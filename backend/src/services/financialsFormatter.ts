...
const coerceArray = (input: unknown): any[] => {
...
const describeFiling = (filing: any): string => {
...
export const buildFinancialStatementExcerpts = (
  finReports: any[],
  options: { limitPerStatement?: number; includeToolHint?: boolean } = {},
): FinancialStatements => {
...
export const buildFinancialStatementDetail = (
  finReports: any[],
  section: SectionKey,
  options: { limitPerStatement?: number } = {},
): string | null => {
